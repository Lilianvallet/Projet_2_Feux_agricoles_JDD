...
---
# Land cover data
.left-column[<video data-autoplay muted width="650" controls autoplay muted >
  <source src="scripts/JDD_files/figure-html/LandCover_sattelite.mp4" type="video/mp4">
</video>]
.right-column[<video data-autoplay width="1000" controls autoplay muted>
...
.left-column[<video data-autoplay width="650" controls autoplay muted>
  <source src="scripts/JDD_files/figure-html/MODIS_sattelite_compressed.mp4" type="video/mp4">
</video>]

.right-column[<video data-autoplay width="650" controls autoplay muted>
...
**Land cover data** 
.pull-left[.pull-left[<video data-autoplay width="1000" controls autoplay muted>
  <source src="scripts/JDD_files/figure-html/FarEarth_compressed.mp4" type="video/mp4">
</video>
...
.pull-right[<video data-autoplay width="1000" controls autoplay muted>
  <source src="scripts/JDD_files/figure-html/VIIRS.mp4" type="video/mp4">
</video>]
]
...
.pull-left[.pull-left[
**Land cover data** 
<video data-autoplay width="1000" controls autoplay muted>
